...
#define SLAVE_OK_GPIO CONFIG_SLAVE_GPIO_OK
#define SLAVE_NOK_GPIO CONFIG_SLAVE_GPIO_NOK
#define SLAVE_GARAGE_CMD_GPIO CONFIG_SLAVE_GARAGE_CMD_GPIO
#define SLAVE_BIGGATE_CMD_GPIO CONFIG_SLAVE_BIGGATE_CMD_GPIO

#define SLAVE_GPIO_OUTPUT_LEDS ((1ULL << BLINK_GPIO) | (1ULL << SLAVE_OK_GPIO) | (1ULL << SLAVE_NOK_GPIO))
